...
means = [[np.random.randint(1,2),np.random.randint(1,2)] for i in range(K)]
...
def em_gmm(data,means,covs,pi,tol, max_iter):
	...
	#### This part is for evaluating the current responsibilities 
		...
		if l == 1:
			intermediate.append([pi,means,covs,ll_new])
		if l == 5:
			intermediate.append([pi,means,covs,ll_new])
		if l == 10:
			intermediate.append([pi,means,covs,ll_new])
	...
	return pi, means, covs, ll_new, intermediate

A = em_gmm(gmm_data,means,covs,pi,0.005,100)
#print('This is intermediate vector ' + str(A[4]))
#print('This is first entry of intermediate vector' + str(A[4][1]))
...
#fig.add_subplot(121)
show(gmm_data, A[4][0][1], A[4][0][2])
show(gmm_data, A[4][1][1], A[4][1][2])
show(gmm_data, A[4][2][1], A[4][2][2])
show(gmm_data, A[4][3][1], A[4][3][2])
show(gmm_data, A[4][4][1], A[4][4][2])
print(A[4][4][1])
print(A[4][4][2])
#fig.add_subplot(122)
